...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2022 a las 19:25:57
...
CREATE TABLE `percepcion` (
  ...
  `pornomina_personal` varchar(2) NOT NULL,
  `id_nomina` int(11) NOT NULL,
  `valor` int(11) DEFAULT NULL,
  `dia_por` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `percepcion` (`idpercepcion`, `descripcion`, `idperiodo`, `dia`, `mes`, `pornomina_personal`, `id_nomina`, `valor`, `dia_por`) VALUES
(1, 'Tabajador', 4, NULL, NULL, 'P', 1, NULL, NULL),
(2, 'Sueldo', 4, 5, 30, 'N', 2, 15, NULL),
(3, 'Aguinaldo', 7, 12, 17, 'P', 3, 365, NULL),
(4, 'Prima vacacional', 7, 4, 17, 'N', 2, 15, NULL);
...
INSERT INTO `periodo` (`idperiodo`, `descripcion`) VALUES
(4, 'quincenal'),
(5, 'semanal'),
(6, 'catorcenal'),
(7, 'Anual');
...
ALTER TABLE `percepcion`
  ...
  ADD KEY `idperiodo` (`idperiodo`,`id_nomina`),
  ADD KEY `idtipo_nomina` (`id_nomina`);
...
--
ALTER TABLE `nivelacademico`
  MODIFY `idNivelAcademico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `percepcion`
--
ALTER TABLE `percepcion`
  MODIFY `idpercepcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tipo_nomina`
  MODIFY `id_nomina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Filtros para la tabla `percepcion`
--
ALTER TABLE `percepcion`
  ADD CONSTRAINT `percepcion_ibfk_1` FOREIGN KEY (`idperiodo`) REFERENCES `periodo` (`idperiodo`) ON UPDATE CASCADE,
  ADD CONSTRAINT `percepcion_ibfk_2` FOREIGN KEY (`id_nomina`) REFERENCES `tipo_nomina` (`id_nomina`) ON UPDATE CASCADE;
